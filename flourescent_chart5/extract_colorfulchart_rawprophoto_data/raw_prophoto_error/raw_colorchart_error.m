...
load('C:\Users\workshop\Documents\hakki\FALL15\Research\cvpr16\colorimetry_experiments\flourescent_chart5\extract_colorfulchart_rawprophoto_data\samsung_s6_edge\data.mat','data');
s6_prophoto_raw = data;
clear data

load('C:\Users\workshop\Documents\hakki\FALL15\Research\cvpr16\colorimetry_experiments\flourescent_chart5\extract_colorfulchart_rawprophoto_data\motorola_nexus6\data.mat','data');
nexus_prophoto_raw = data;
clear data

load('C:\Users\workshop\Documents\hakki\FALL15\Research\cvpr16\colorimetry_experiments\flourescent_chart5\extract_colorfulchart_rawprophoto_data\lg_g4\data.mat','data');
lg_prophoto_raw = data;
clear data

load('C:\Users\workshop\Documents\hakki\FALL15\Research\cvpr16\colorimetry_experiments\flourescent_chart5\extract_colorfulchart_rawprophoto_data\htc_one_m9\data.mat','data');
...
for i=1:81
    ...
    set(h1,'color',c);     
    title('RAW ProPhotoRGB Stage - 81 Color Chart', 'FontSize', fontSize);
    grid on;    
    hold on;
end 
